...
import {TeachingItems, SectionId} from '../../data/data';
import {TeachingItem} from '../../data/dataDef';
import useDetectOutsideClick from '../../hooks/useDetectOutsideClick';
import Section from '../Layout/Section';

const Teaching: FC = memo(() => {
  return (
    <Section className="bg-neutral-1000" sectionId={SectionId.Teaching}>
...
const ItemOverlay: FC<{item: TeachingItem}> = memo(({item: {url, title, description}}) => {
